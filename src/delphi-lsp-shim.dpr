...
uses
  ...
  DelphiLsp.Env in 'units\DelphiLsp.Env.pas',
  DelphiLsp.Gc in 'units\DelphiLsp.Gc.pas',
  DelphiLsp.HookEntry in 'units\DelphiLsp.HookEntry.pas',
  DelphiLsp.IO in 'units\DelphiLsp.IO.pas',
  DelphiLsp.JsonUtils in 'units\DelphiLsp.JsonUtils.pas',
  DelphiLsp.Logging in 'units\DelphiLsp.Logging.pas',
  DelphiLsp.LspMessage in 'units\DelphiLsp.LspMessage.pas',
  DelphiLsp.LspPathResolver in 'units\DelphiLsp.LspPathResolver.pas',
  DelphiLsp.LspSession in 'units\DelphiLsp.LspSession.pas',
  DelphiLsp.LspWire in 'units\DelphiLsp.LspWire.pas',
  DelphiLsp.Paths in 'units\DelphiLsp.Paths.pas',
  DelphiLsp.PluginData in 'units\DelphiLsp.PluginData.pas',
  DelphiLsp.ProcessTree in 'units\DelphiLsp.ProcessTree.pas',
  DelphiLsp.Sentinels in 'units\DelphiLsp.Sentinels.pas',
  DelphiLsp.SentinelWatcher in 'units\DelphiLsp.SentinelWatcher.pas',
  DelphiLsp.SessionIdResolver in 'units\DelphiLsp.SessionIdResolver.pas',
  DelphiLsp.SessionRegistry in 'units\DelphiLsp.SessionRegistry.pas',
  DelphiLsp.SettingsResolver in 'units\DelphiLsp.SettingsResolver.pas',
  DelphiLsp.StickyState in 'units\DelphiLsp.StickyState.pas',
  DelphiLsp.Walkers in 'units\DelphiLsp.Walkers.pas',
  DelphiLsp.XmlDecode in 'units\DelphiLsp.XmlDecode.pas';
